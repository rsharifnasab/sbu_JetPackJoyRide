...
{
    if (s==missle_warning_s) {
        std::cout << "missle sound\n";
    }
    ...
    if (s==change_barry_s) {
        SBDL::playSound (change_barry_sound, 1);
    }

    if (s==grav1_s) {
        SBDL::playSound (grav1_sound, 1);
    }

    if (s==grav2_s) {
        SBDL::playSound (grav2_sound, 1);
    }

    if (s==on_s) {
        SBDL::playSound (on_sound, 1);
    }

    if (s==missle_warning_s) {
        SBDL::playSound (missle_warning_sound, 1);
    }

    if (s==laser_warning_s) {
        SBDL::playSound (laser_warning_sound, 1);
    }
